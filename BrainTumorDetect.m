...
% Last Modified by GUIDE v2.5 24-JUNE-2023 12:58:09
...
if nofile 
    msbox(sprintf('Image not found !!!'),'Error','Warning');
    return
end
...
title('\fontsize{20}\color[rgb]{0.996, 0.592, 0.0} Tumour Detected');
